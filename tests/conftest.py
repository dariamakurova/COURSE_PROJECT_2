...
def vacancy_data_hh():
    return {
        ...
        "relations": [],
        "employer": {"id": "3499705", "name": "Company", "url": "https://api.hh.ru/employers/3499705"},
        "snippet": {
        ...
        "items": [
            {
                ...
                "alternate_url": "http://example.com",
                "employer": {"id": "3499705", "name": "Company", "url": "https://api.hh.ru/employers/1"},
                "snippet": {"requirement": "Тестовые требования", "responsibility": "Тестовые обязанности"},
            },
            {
                "id": "123457",
                "premium": False,
                ...
                "alternate_url": "http://example.com",
                "employer": {"id": "3499705", "name": "Other Company", "url": "https://api.hh.ru/employers/2"},
                "snippet": {"requirement": "Тестовые требования", "responsibility": "Тестовые обязанности"},
            },
        ]
    }
...
def vacancy_obj():
    ...
    return Vacancy(
        ...
        "Company Vac",
        "http://example.com",
        {"from": 350000, "to": 450000, "currency": "RUR"},
        "Тестовые требования Vac",
    )
...
def vacancies_list():
    return [
        Vacancy(
            "1", "Разработчик", "Company_1", "url", {"from": 100000, "to": 150000, "currency": "RUR"}, "Python, SQL"
        ),
        Vacancy("2", "Тестировщик", "Company_2", "url", {"from": 80000, "to": 120000, "currency": "RUR"}, "Java"),
        Vacancy("3", "Аналитик", "Company_3", "url", {"from": 170000, "to": 200000, "currency": "RUR"}, "Python"),
    ]
